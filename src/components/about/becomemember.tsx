  ...
  return (
    <>
      ...
      <div className="w-full bg-winc-red-400 p-3 px-8 lg:px-16">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3 xl:gap-10">
          {memberCards.map((memberCard, index) => (
            ...
            >
              <Image
                ...
                height={40}
              />
              <p className="mb-3 text-xl font-bold md:text-sm lg:text-lg xl:text-xl">
                {memberCard.title}
              </p>
              <p className="text-md lg:text-md md:text-xs xl:text-lg">
                {memberCard.text}
              </p>
            </div>
          ))}
