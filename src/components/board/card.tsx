...
const Card = ({
  ...
  return (
    <div className="mx-auto mb-6 flex w-4/5 flex-col shadow-[8px_-8px_0px_0px] shadow-winc-orange-100">
      <div className="flex flex-col bg-winc-beige-100 text-left">
        <Image
          src={image}
          alt="text"
          className="flex aspect-square flex-col justify-center p-6"
        />
