  ...
  return (
    <>
      <div className="flex justify-center">
        <div className="w-5/12 h-1/12 bg-winc-yellow flex items-center justify-center ">
          <div className="box-border p-4 border-8 border-winc-white w-11/12 h-3/4 bg-winc-yellow flex items-center justify-center">
