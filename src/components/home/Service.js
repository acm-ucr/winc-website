...
const Service = ({
  ...
  return (
    <div
      className={` ${backgroundColor} w-11/12 rounded-3xl min-w-fit flex items-center justify-center flex-col font-urbanist p-4`}
    >
      <div className="pt-6">{icon}</div>
      <div
        className={` ${textColor} flex text-center text-2xl md:text-4xl my-4 justify-center font-bold`}
      >
        {topic}
      </div>
      <p
